    ...
    return (
        <html lang="en" className={newsreader.className}>
            <body>
                ...
                <footer>
                    <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/sam-vonbergen/" className="linkedin-icon">
                        <svg viewBox="-2 -2 24.00 24.00" xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke="currentColor" strokeWidth="0.82">
